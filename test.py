...
class NeuralNetwork:
    def __init__(self, n_neurons_in_hidden_layers: list[int], learning_rate=1e-5):
    ...
    def fit(self, X, y):
        ...
        self.B = [np.zeros((1, self.n_neurons[i])) for i in range(1, self.n_layers + 1)]
